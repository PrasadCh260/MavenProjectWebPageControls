...
public class Frames {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.id("name")).sendKeys("Prasad1"); // main web Page
		Thread.sleep(3000);
		...
		driver.findElement(By.id("firstName")).sendKeys("Babu");
		Thread.sleep(3000);
		...
		driver.findElement(By.id("name")).sendKeys("Prasad2"); // main web Page
